...
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │  ${BICyan}[${BIWhite}01${BICyan}] SSH WS   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}  [${BIWhite}08${BICyan}] CEK RUNNING   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}    │${NC}"
echo -e "${BICyan} │  ${BICyan}[${BIWhite}02${BICyan}] XRAYS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}  [${BIWhite}09${BICyan}] INSTALL UDP   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}    │${NC}"
...
echo -e "${BICyan} │  ${BICyan}[${BIWhite}06${BICyan}] SETTINGS ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}  [${BIWhite}13${BICyan}] UPDATE SCRIPT ${BICyan}[${BIYellow}Menu${BICyan}]${NC}""${BICyan}    │${NC}"
