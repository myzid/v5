...
echo -e "\033[1;93m┌─────────────────────────────────────────────────┐\033[0m"
echo -e "${BICyan}\033[0m ${BOLD}          ${GREEN}    ${BIYellow} TROJAN    TROJAN GO ${GREEN}   $NC "
echo -e "${BICyan}\033[0m ${Blue}                  $tra         $ssa $NC"
echo -e "\e[33m└─────────────────────────────────────────────────┘\033[0m"
echo -e "\033[1;93m┌─────────────────────────────────────────────────┐\033[0m"
echo -e "\033[1;93m│\033[0m            ${RED}SCRIPT BY FV STORE TUNNEL$NC \033[1;93m           │\033[0m"
echo -e "\033[1;93m└─────────────────────────────────────────────────┘\033[0m"
echo -e " [\e[36m•01\e[0m] Create Trojan Ws         [\e[36m•06\e[0m] Create Trojan Go"
echo -e " [\e[36m•02\e[0m] Trial Trojan Ws          [\e[36m•07\e[0m] Trial Trojan Go"
echo -e " [\e[36m•03\e[0m] Renew Trojan Ws          [\e[36m•08\e[0m] Renew Trojan Go"
echo -e " [\e[36m•04\e[0m] Dellete Trojan Ws        [\e[36m•09\e[0m] Dellete Trojan Go"
echo -e " [\e[36m•05\e[0m] Cek User Trojan Ws       [\e[36m•10\e[0m] Cek User Trojan Go"
echo -e ""
