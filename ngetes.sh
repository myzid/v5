...
clear
echo -e "${yellow}┌─────────────────────────────────────────────────┐${NC}"
echo -e "${yellow}│${NC}               SETUP DOMAIN MENU                 ${yellow}│${NC}"
echo -e "${yellow}└─────────────────────────────────────────────────┘${NC}"
echo -e ""
...
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "https://raw.githubusercontent.com/nishikazekazata/hah/main/ws/ws.py" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/nishikazekazata/hah/main/xray/ws.service" >/dev/null 2>&1
